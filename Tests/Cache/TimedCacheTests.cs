...
public class TimedCacheTests
{
    ...
    {
        public TestTimedCache(float updateInterval, bool updateOnFirstAccess = false)
            : base(updateInterval, updateOnFirstAccess) { }
    }
    ...
    public void Update_FirstCall_WithUpdateOnFirstAccess_ReturnsTrue()
    {
        ...
        var cache = new TestTimedCache(updateInterval: 10f, updateOnFirstAccess: true);
    ...
    public void Update_FirstCall_WithoutUpdateOnFirstAccess_ReturnsFalse()
    {
        ...
        var cache = new TestTimedCache(updateInterval: 10f, updateOnFirstAccess: false);
        var time = new RimWorldTime(0, 0, 0f);
    ...
    public void Update_WithZeroInterval_AlwaysDue()
    {
        ...
        var cache = new TestTimedCache(updateInterval: 0f, updateOnFirstAccess: false);
        var time1 = new RimWorldTime(0, 0, 0f);
    ...
    public void Update_CrossesMultipleDays()
    {
        ...
        var cache = new TestTimedCache(updateInterval: 50f, updateOnFirstAccess: false);
        var time1 = new RimWorldTime(0, 0, 0f);
    ...
    public void Update_CrossesYears()
    {
        ...
        var cache = new TestTimedCache(updateInterval: 1000f, updateOnFirstAccess: false);
        var time1 = new RimWorldTime(0, 0, 0f);
    ...
    public void Update_FirstCallWithTime_RecordsTime()
    {
        ...
        var cache1 = new TestTimedCache(updateInterval: 10f, updateOnFirstAccess: true);
        var cache2 = new TestTimedCache(updateInterval: 10f, updateOnFirstAccess: false);
        var time1 = new RimWorldTime(0, 0, 0f);
    ...
    public void Update_LargeInterval()
    {
        ...
        var cache = new TestTimedCache(updateInterval: 10000f, updateOnFirstAccess: false);
        var time1 = new RimWorldTime(0, 0, 0f);
