...
public class StatefulSubsystemTests : IClassFixture<StaticStateFixture>
{
    ...
    public StatefulSubsystemTests(StaticStateFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public void PawnFilter_Copy_IsIndependent()
    {
        ...
        var original = new PawnFilter
        {
            ...
            AllowedPawnHealthStates = LordKuper.Common.Filters.PawnHealthState.Healthy
        };
        ...
        copy.AllowedPawnHealthStates = LordKuper.Common.Filters.PawnHealthState.Downed;

        // Original should be unchanged
        Assert.Single(original.AllowedPawnTypes);
        Assert.Equal(LordKuper.Common.Filters.PawnHealthState.Healthy, original.AllowedPawnHealthStates);
    }
