...
public class MathHelperTests
{
    ...
    public void NormalizeValue_ValueBelowRange_ClampsAndNormalizes()
    {
        ...
        Assert.Equal(0f, result); // clamped to 10, normalized to 0
    }
    ...
    public void NormalizeValue_ValueAboveRange_ClampsAndNormalizes()
    {
        var range = new FloatRange(10f, 20f);
        var result = MathHelper.NormalizeValue(50f, range);
        Assert.Equal(1f, result); // clamped to 20, normalized to 1
    }
    ...
    [Theory]
    [InlineData(10f, 10f, 20f, 0f)]
    [InlineData(15f, 10f, 20f, 0.5f)]
    [InlineData(20f, 10f, 20f, 1f)]
    [InlineData(5f, 10f, 20f, 0f)] // clamped below
    [InlineData(25f, 10f, 20f, 1f)] // clamped above
