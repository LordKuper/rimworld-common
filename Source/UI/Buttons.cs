...
public static class Buttons
{
    ...
    public static void DoActionButton(Rect rect, string? label, Action action,
        string? tooltip = null, bool isEnabled = true)
    {
    ...
    public static float DoActionButtonGrid(Rect rect, ActionButton[] actionButtons,
        out Rect remRect)
    {
    ...
    /// </exception>
    public static void DoIconButtonToggle(Rect rect, Func<bool> getter, Action<bool> setter,
        string? enabledTooltip, Texture2D enabledIcon, string? disabledTooltip,
    ...
    public static void DoIconButtonToggle(Rect rect, ref bool value, string? enabledTooltip,
