...
/// <summary>
///     Saves and restores global static state around each test so that tests do not
///     leak state to one another and can run in any order.
/// </summary>
/// <remarks>
...
///     - SkillStatMap static cache (reset via Reflection)
